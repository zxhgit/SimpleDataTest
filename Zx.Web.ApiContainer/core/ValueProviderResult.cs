...
namespace Zx.Web.ApiContainer.core
{
    ...
    public class ValueProviderResult
    {
        ...
        public ValueProviderResult(string rawName, object rawValue, string attemptedValue, CultureInfo culture)
        {
            RawName = rawName;
            RawValue = rawValue;
        ...
        private static object ConvertSimpleType(CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (!(canConvertFrom || converter.CanConvertTo(destinationType)))
            {
                ...
                string message = String.Format(CultureInfo.CurrentCulture, "The parameter conversion from type '{0}' to type '{1}' failed because no type converter can convert between these types.",
            ...
            {
                string message = String.Format(CultureInfo.CurrentCulture, "The parameter conversion from type '{0}' to type '{1}' failed. See the inner exception for more information.",
                                               value.GetType().FullName, destinationType.FullName);
