        ...
        internal void RunAll()
        {
            ...
            ExampleRunner.RunQuery(
                ...
                db => db.Albums.FindAllByGenreId(1)
                        ...
                        .Select(
                            ...
                            db.Genre.Name),
                new List<string> {"Title", "Name"});
            //无法绑定由多个部分组成的标识符“dbo.Genres.Name”
            ...
            ExampleRunner.RunQuery(
                ...
                db => db.Albums.FindAllByGenreId(1)
                        ...
                        .On(),
                new List<string> {"Title", "Name"});
            //On expects an expression or named parameters
            ...
            ExampleRunner.RunQuery(
                ...
                new List<string> {"Title", "Name"});
            //select [dbo].[Albums].[Title],[dbo].[Genres].[Name]
            //from [dbo].[Albums] JOIN [dbo].[Genres]
            //ON ([dbo].[Albums].[GenreId] IS NULL)
            ...
            ExampleRunner.RunQuery(
                ...
                db => db.Albums.FindAllByGenreId(1)
                        .Select(
                            ...
                            db.Genre.Name)
                        .Join(db.Genre)
                        .On(db.Albums.GenreId = db.Genre.GenreId),//=应为==
                new List<string> {"Title", "Name"});
            //Simple.Data.BadExpressionException
            //Cannot assign values to table columns.
