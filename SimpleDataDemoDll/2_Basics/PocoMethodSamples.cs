...
namespace SimpleDataDemoDll
{
    internal class PocoMethodSamples
    {
        internal void RunAll()
        {
            ...
            //ListReturnedProperties方法line92，Album album = results;会将dynamic转换成Album——利用DynamicObject
            ...
            //ListReturnedProperties方法line92，Album album = results;
            //将list of albums转换成single album失败
            ...
            //single album转list of albums不抛异常
